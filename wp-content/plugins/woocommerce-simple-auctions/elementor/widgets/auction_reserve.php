...
class Auction_reserve extends Base_Widget {
	...
	protected function render() {
		...
		if( is_admin() ){ ?>
			<p class="reserve hold"  data-auction-id="<?php echo esc_attr( $product->get_id() ); ?>" ><?php echo apply_filters( 'reserve_bid_text', esc_htmlesc_html__( 'Reserve price has not been met', 'wc_simple_auctions' ) ); ?></p>
		<?php }
